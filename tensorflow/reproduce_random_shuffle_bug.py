...
# TODO: [  ] KittiContinuous/ImagesBatch/train.batch/Ambos/Juntos
...
# Um dos erros que deu indicava que talvez uma das imagens de depth tivesse formato inválido, isto é, que não fosse PNG. R.: Código conseguiu ler todas as imagens.
