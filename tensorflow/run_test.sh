...
# python3 predict_nick.py -m train --machine ${USER} --gpu ${GPU} -s apolloscape --px valid --loss silog --max_steps ${STEPS} --ldecay --l2norm --data_aug  # Avoid! Does the Gradients calculation make sense for the 'valid' flag?
...
#python3 predict_nick.py -m train --machine ${USER} --gpu ${GPU} -s kittidepth --px valid --loss silog --max_steps ${STEPS} --ldecay --l2norm --data_aug  # Avoid! Does the Gradients calculation make sense for the 'valid' flag?
...
#python3 predict_nick.py -m train --machine ${USER} --gpu ${GPU} -s kittidiscrete --px valid --loss silog --max_steps ${STEPS} --ldecay --l2norm --data_aug  # Avoid! Does the Gradients calculation make sense for the 'valid' flag?
...
#python3 predict_nick.py -m train --machine ${USER} --gpu ${GPU} -s kitticontinuous --px valid --loss silog --max_steps ${STEPS} --ldecay --l2norm --data_aug  # Avoid! Does the Gradients calculation make sense for the 'valid' flag?
...
#python3 predict_nick.py -m train --machine ${USER} --gpu ${GPU} -s nyudepth --px valid --loss silog --max_steps ${STEPS} --ldecay --l2norm --data_aug  # Avoid! Does the Gradients calculation make sense for the 'valid' flag?
