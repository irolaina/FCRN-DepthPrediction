...
class KittiContinuous(Dataset):
    def __init__(self, **kwargs):
        super(KittiContinuous, self).__init__(**kwargs)
    ...
    def get_filenames_lists(self, mode, test_split='', test_file_path=''):
        ...
        if os.path.exists(file_path):
            ...
            # TODO: Este trecho deverá estar de acordo com o que foi desenvolvido em generate_new_split_kitti_continuous.py
            raise SystemError
