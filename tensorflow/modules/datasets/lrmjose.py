...
#  Class Declaration
# ===================
class LRMJose(Dataset):
    def __init__(self, **kwargs):
        super(LRMJose, self).__init__(**kwargs)
    ...
    def get_filenames_lists(self, mode, test_split='', test_file_path=''):
        ...
        if os.path.exists(file_path):
            ...
            image_filenames_tmp = glob.glob(self.dataset_path + "Camera_RGB/*.png")
            depth_filenames_tmp = glob.glob(self.dataset_path + "Camera_Depth2/*.png")

            print(self.dataset_path + "Camera_RGB/*.png")
