...
python3 predict_nick.py -m train --machine ${USER} --gpu ${GPU} -s kitti_continuous --px valid --loss mse         --max_steps ${STEPS} --ldecay --l2norm --data_aug
python3 predict_nick.py -m train --machine ${USER} --gpu ${GPU} -s kitti_continuous --px valid --loss berhu       --max_steps ${STEPS} --ldecay --l2norm --data_aug
python3 predict_nick.py -m train --machine ${USER} --gpu ${GPU} -s kitti_continuous --px valid --loss eigen       --max_steps ${STEPS} --ldecay --l2norm --data_aug
python3 predict_nick.py -m train --machine ${USER} --gpu ${GPU} -s kitti_continuous --px valid --loss eigen_grads --max_steps ${STEPS} --ldecay --l2norm --data_aug  # Avoid! Does the Gradients calculation make sense for the 'valid' flag?
python3 predict_nick.py -m train --machine ${USER} --gpu ${GPU} -s kitti_continuous --px all   --loss mse         --max_steps ${STEPS} --ldecay --l2norm --data_aug
python3 predict_nick.py -m train --machine ${USER} --gpu ${GPU} -s kitti_continuous --px all   --loss berhu       --max_steps ${STEPS} --ldecay --l2norm --data_aug
python3 predict_nick.py -m train --machine ${USER} --gpu ${GPU} -s kitti_continuous --px all   --loss eigen       --max_steps ${STEPS} --ldecay --l2norm --data_aug
python3 predict_nick.py -m train --machine ${USER} --gpu ${GPU} -s kitti_continuous --px all   --loss eigen_grads --max_steps ${STEPS} --ldecay --l2norm --data_aug
