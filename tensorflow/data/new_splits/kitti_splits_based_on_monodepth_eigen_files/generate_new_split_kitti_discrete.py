...
# Save
np.savetxt('kitti_discrete/eigen_train_files.txt', np.array(eigen_train), fmt='%s', delimiter='\t')
...
# Save
np.savetxt('kitti_discrete/eigen_test_files.txt', np.array(eigen_test), fmt='%s', delimiter='\t')
